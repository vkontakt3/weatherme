...
import "./App.css";
import SectionTemperature from "../section-temperature/section-temperature"; // Исправлено
import ForcastForAnotherDay from "../ForcastForAnotherDay/ForcastForAnotherDay";
  ...
  return (
    <>
      <div className="input-wrapper">
        <button onClick={HandleSearch} className="button-icon">
          <svg
      ...
      <SectionTemperature city={city} /> {/* Исправлено */}
      <ForcastForAnotherDay city={city} />
    </>
  );
}
